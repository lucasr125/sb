...
if EnterKey == "SlapBattlesScriptGetBannedplsnotBanned" or EnterKey == "GetSomeBannedPlsAdminDontBannedYou" or EnterKey == "" then   
local UIScale = Create("UIScale", screenGui)
...
local Window = OrionLib:MakeWindow({IntroText = "Slap Battles 👏", IntroIcon = "rbxassetid://7733955740",Name = ("Slap Battles 👏".." | ".. identifyexecutor()), HidePremium = false, SaveConfig = false, IntroEnabled = false, ConfigFolder = "slap battles"})
