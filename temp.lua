	...
	Tab3:AddButton({
		...
		Callback = function()
			if game.Players.LocalPlayer.Character.Humanoid.Health ~= 0 then
				...
				OrionLib:MakeNotification({Name = "Warning",Content = "You already died",Image = "rbxassetid://7733658504",Time = 5})
			end
		end    
	})
	...
	Tab3:AddButton({
		...
		Callback = function()
			if game.Players.LocalPlayer.leaderstats.Glove.Value == "Stun" and game.Players.LocalPlayer.Character:FindFirstChild("entered") then
				...
				repeat
					...
					if game.Players.LocalPlayer.Character and game.Players.LocalPlayer.Character:FindFirstChild("EMPStunBadgeCounter") then
						OrionLib:MakeNotification({
							Name = "Counting",
							Content = "Stuns: " .. game.Players.LocalPlayer.Character.EMPStunBadgeCounter.Value,
				...
				OrionLib:MakeNotification({
					Name = "Error",
					Content = "You don't have Stun glove equipped, or you aren't in the arena",
					Image = "rbxassetid://7733658504",
					Time = 5
				})
			end	
	...
	Tab3:AddButton({
		...
		Callback = function()
			if game.Players.LocalPlayer.leaderstats.Glove.Value == "Fort" and not game:GetService("BadgeService"):UserHasBadgeAsync(game.Players.LocalPlayer.UserId, 4031317971987872) then
				...
				OrionLib:MakeNotification({Name = "Error",Content = "You don't have Fort glove equipped or you already own the badge.",Image = "rbxassetid://7733658504",Time = 5})
			end
		end    
	})
...
fireclickdetector(v)
	...
	ReplicaAndBallerAndBlinkFarm = Tab14:AddToggle({
		Name = "Baller & Replica & Blink Slap Farm",
		Default = false,
		Callback = function(Value)
...
for _,v in pairs(game.Players.LocalPlayer.Character:GetChildren()) do
	...
	if game.Workspace:FindFirstChild("ToggleAntis") == nil then
		local ToggleAntis = Instance.new("BoolValue", workspace)
		ToggleAntis.Name = "ToggleAntis"
	end
	Tab2:AddToggle({
		Name = "All Toggle Anti",
		Default = false,
		Callback = function(Value)
			game.Workspace.ToggleAntis.Value = Value
		end    
	})

	Tab2:AddDropdown({
		Name = "Select anti void",
		Default = "Normal",
	...
	Tab2:AddSlider({
		Name = "Set anti void transparency",
		Min = 0,
		Max = 1,
		Default = 0.5,
		Color = Color3.fromRGB(255,255,255),
			...
			while AntiMods do
				for i,v in pairs(game.Players:GetChildren()) do
					if v:GetRankInGroup(9950771) >= 2 then
						_G.AntiKick = false
						game.Players.LocalPlayer:Kick("Admin detected: ".. v.Name)
						break
					end
				end
				task.wait()
	...
	AntiSbeve = Tab2:AddToggle({
		...
		Callback = function(Value)
			...
			if _G.AntiSbeve == false then
				for _,v in pairs(game.Players:GetChildren()) do
					if v ~= game.Players.LocalPlayer and v.Character:FindFirstChild("stevebody") then
						v.Character:FindFirstChild("stevebody").CanTouch = true
						v.Character:FindFirstChild("stevebody").CanQuery = true
						v.Character:FindFirstChild("stevebody").CanCollide = true
						task.wait()
					end
				end
			end
	...
	AntiBallBaller = Tab2:AddToggle({
		...
		Callback = function(Value)
			...
			if _G.AntiBallBaller == false then
				for i,v in pairs(game.Workspace:GetChildren()) do
					if v.Name == "ClonedBall" then
						v.CanTouch = true
						v.CanCollide = true
	...
	AntiNightmareAndPotion = Tab2:AddToggle({
		Name = "Anti nightmare effect",
		Default = false,
		Callback = function(Value)
			if Value == true then
				game.Players.LocalPlayer.PlayerScripts.VFXListener:FindFirstChild("NightmareEffect").Parent = game.Lighting
			else
				game.Lighting:FindFirstChild("NightmareEffect").Parent = game.Players.LocalPlayer.PlayerScripts.VFXListener
			end
		end    
	})
	...
	game.Workspace:FindFirstChild("ToggleAntis").Changed:Connect(function()
		AntiAdmin:Set(game.Workspace:FindFirstChild("ToggleAntis").Value)
		AntiAfk:Set(game.Workspace:FindFirstChild("ToggleAntis").Value)
		AntiAttackPlank:Set(game.Workspace:FindFirstChild("ToggleAntis").Value)
		AntiBallBaller:Set(game.Workspace:FindFirstChild("ToggleAntis").Value)
		AntiBooster:Set(game.Workspace:FindFirstChild("ToggleAntis").Value)
		AntiBrick:Set(game.Workspace:FindFirstChild("ToggleAntis").Value)
		AntiBubble:Set(game.Workspace:FindFirstChild("ToggleAntis").Value)
		AntiBus:Set(game.Workspace:FindFirstChild("ToggleAntis").Value)
		AntiCannonBall:Set(game.Workspace:FindFirstChild("ToggleAntis").Value)
		AntiCOD:Set(game.Workspace:FindFirstChild("ToggleAntis").Value)
		AntiConveyor:Set(game.Workspace:FindFirstChild("ToggleAntis").Value)
		AntiDeath:Set(game.Workspace:FindFirstChild("ToggleAntis").Value)
		AntiDefend:Set(game.Workspace:FindFirstChild("ToggleAntis").Value)
		AntiFort:Set(game.Workspace:FindFirstChild("ToggleAntis").Value)
		AntiIceAndPotion:Set(game.Workspace:FindFirstChild("ToggleAntis").Value)
		AntiJack:Set(game.Workspace:FindFirstChild("ToggleAntis").Value)
		AntiKick:Set(game.Workspace:FindFirstChild("ToggleAntis").Value)
		AntiKnock:Set(game.Workspace:FindFirstChild("ToggleAntis").Value)
		AntiLure:Set(game.Workspace:FindFirstChild("ToggleAntis").Value)
		AntiMail:Set(game.Workspace:FindFirstChild("ToggleAntis").Value)
		AntiMittenBl:Set(game.Workspace:FindFirstChild("ToggleAntis").Value)
		AntiNightmareAndPotion:Set(game.Workspace:FindFirstChild("ToggleAntis").Value)
		AntiNull:Set(game.Workspace:FindFirstChild("ToggleAntis").Value)
		AntiObby:Set(game.Workspace:FindFirstChild("ToggleAntis").Value)
		AntiPortal:Set(game.Workspace:FindFirstChild("ToggleAntis").Value)
		AntiPusher:Set(game.Workspace:FindFirstChild("ToggleAntis").Value)
		AntiRagdoll:Set(game.Workspace:FindFirstChild("ToggleAntis").Value)
		AntiReaper:Set(game.Workspace:FindFirstChild("ToggleAntis").Value)
		AntiRecord:Set(game.Workspace:FindFirstChild("ToggleAntis").Value)
		AntiReda:Set(game.Workspace:FindFirstChild("ToggleAntis").Value)
		AntiRock:Set(game.Workspace:FindFirstChild("ToggleAntis").Value)
		AntiRun:Set(game.Workspace:FindFirstChild("ToggleAntis").Value)
		AntiSbeve:Set(game.Workspace:FindFirstChild("ToggleAntis").Value)
		AntiSquid:Set(game.Workspace:FindFirstChild("ToggleAntis").Value)
		AntiStun:Set(game.Workspace:FindFirstChild("ToggleAntis").Value)
		AntiTime:Set(game.Workspace:FindFirstChild("ToggleAntis").Value)
		AntiVoid:Set(game.Workspace:FindFirstChild("ToggleAntis").Value)
		AntiZa:Set(game.Workspace:FindFirstChild("ToggleAntis").Value)
		AntiBrazil:Set(game.Workspace:FindFirstChild("ToggleAntis").Value)
	end)

elseif (game.PlaceId == 11828384869) then
	loadstring(game:HttpGet("https://raw.githubusercontent.com/lucasr125/public-scripts/main/SlapBattles_%3F.lua"))();
elseif ((game.PlaceId == 9020359053) or (game.PlaceId == 9412268818)) then
	loadstring(game:HttpGet("https://raw.githubusercontent.com/lucasr125/public-scripts/main/SlapBattles_DevMaps.lua"))();
elseif (game.PlaceId == 13833961666) then
	loadstring(game:HttpGet("https://raw.githubusercontent.com/lucasr125/public-scripts/main/SlapBattles_TheDarkRealm.lua"))();
elseif (game.PlaceId == 9431156611) then
	loadstring(game:HttpGet("https://raw.githubusercontent.com/lucasr125/public-scripts/main/SlapBattles_SlapRoyale.lua"))();
elseif (game.PlaceId == 14422118326) then
	loadstring(game:HttpGet("https://raw.githubusercontent.com/lucasr125/public-scripts/main/SlapBattles_TheNullZone.lua"))();
elseif (game.PlaceId == 15507333474) then
	loadstring(game:HttpGet("https://raw.githubusercontent.com/lucasr125/public-scripts/main/SlapBattles_SLAPBATTLESCHRISTMASEVENT.lua"))();
elseif (game.PlaceId == 16034567693) then
	loadstring(game:HttpGet("https://raw.githubusercontent.com/lucasr125/public-scripts/main/SlapBattles_TheStaffApplication.lua"))();
...
elseif (game.PlaceId == 18550498098) then
	loadstring(game:HttpGet("https://raw.githubusercontent.com/lucasr125/public-scripts/main/SlapBattles_WhereGuideResides.lua"))();
end
------------------------------------------------------------------------
