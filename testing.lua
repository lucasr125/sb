...
game:GetService("TeleportService"):Teleport(6403373529)
  ...
  GetBob = Tab3:AddToggle({Name="Get bob 1.0",Default=false,Callback=function(Value)
  ...
  FarmBob = Tab3:AddToggle({Name="Get bob 2.0",Default=false,Callback=function(Value)
    AutoFarmbob = Value;
    if (game.Players.LocalPlayer.leaderstats.Glove.Value == "Replica") then
  ...
  AutoFarmBrick1 = Tab3:AddToggle({Name="Autofram Brick 1.0",Default=false,Callback=function(Value)
    Brickfarm = Value;
  ...
  AutoFarmBrick2 = Tab3:AddToggle({Name="AutoFarm Brick 2.0",Default=false,Callback=function(Value)
    Brickfarm = Value;
    if (game.Players.LocalPlayer.leaderstats.Glove.Value == "Brick") then
      while Brickfarm do
  ...
  Tab7:AddButton({Name="Kick Player",Callback=function()
  ...
  Tab7:AddButton({Name="Glove No Cooldown Speed",Callback=function()
